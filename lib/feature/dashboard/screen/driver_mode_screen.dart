...
import 'package:mydrivenepal/feature/user-mode/user_mode_viewmodel.dart';
        ...
        children: [
          ...
          GoogleMap(
            ...
            initialCameraPosition: CameraPosition(
              target: _currentPosition ?? _kathmandu,
              zoom: 15.0,
            ),
            markers: _markers,
                      ...
                      children: [
                        Expanded(
                          child: _StatCard(
                            ...
                            subtitle:
                                'NPR ${_todayEarnings.toStringAsFixed(0)}',
                            icon: Icons.today,
                            color: Colors.blue,
                          ),
                        ),
